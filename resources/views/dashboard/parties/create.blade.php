          ...
          <div class="col-sm-12 col-lg-12">
             <div class="iq-card">
                ...
                <div class="iq-card-body">
                   <form id="form-wizard1" class="text-center mt-4" method="POST" action="{{ route('dashboard.parties.store') }}" enctype="multipart/form-data">
                        @csrf
                                 ...
                                 <div class="col-md-6">
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                       ...
                                       <input class="form-control"  name="address" type="input" >
                                    </div>
                                 </div>
                            </div>
                        </div>
